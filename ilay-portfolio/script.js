...
const TRANSLATIONS = {
    he: {
        ...
        aboutP1: 'אני מפתח תוכנה מקצועי עם תשוקה ליצירת פתרונות דיגיטליים חדשניים ואיכותיים. אני מתמחה ביצירת אתרי תדמית ובתחזוקה שוטפת שלהם, וכן בבניית אתרי מכירות — אתרי מכירות אני בונה ולא מתחזק; אכוון אתכם לחברות מקצועיות שמתמחות בתחזוקת אתרי מסחר.',
        ...
        service2Desc: 'בניית אתרי מסחר ואי־קומרס. תחזוקה שוטפת אינה במסגרת השירות — אכוון אתכם לחברות שמתמחות בתחזוקת אתרי מכירות.',
        ...
        pricing3Desc: 'אתר מסחר עם קטגוריות, עגלת קניות וממשק ניהול בסיסי. ללא תחזוקה — אכוון לחברות תחזוקה.',
        pricing3Price: 'החל מ־₪2,750',
        pricing3F1: 'עגלת קניות',
        pricing3F2: 'קטגוריות מוצרים',
        pricing3F3: 'הכוונה לחברת תחזוקה',
    ...
    en: {
        ...
        service2Desc: 'Online stores and e‑commerce. Ongoing maintenance is not included — I\'ll direct you to companies that specialize in e‑commerce maintenance.',
        ...
        pricing3Desc: 'Online store with categories, cart, and basic admin. No maintenance — I\'ll direct you to maintenance companies.',
        pricing3Price: 'From ₪2,750',
        pricing3F1: 'Shopping cart',
        pricing3F2: 'Product categories',
        pricing3F3: 'Direction to maintenance company',
